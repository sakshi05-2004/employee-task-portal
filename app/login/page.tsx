          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                required
                className="w-full rounded-xl border border-ink-200 px-3.5 py-2.5 pr-12 text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
              />
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-lg text-ink-500 hover:text-ink-900"
              >
                {showPassword ? "🙈" : "👁️"}
              </button>
            </div>
